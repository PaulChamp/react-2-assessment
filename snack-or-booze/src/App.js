...
function App() {
  ...
  const addSnacksAndDrinks = async(newSnack) => {
    if (newSnack.type === 'snack') {
      ...
      setDrinks(drinks => [...drinks, newSnack]);
    };
  ...
  const message = `We have ${numSnacks} snacks and ${numDrinks} drinks available!`;
        ...
        <main>
          <Switch>
            ...
            <Route exact path="/snacks">
              <Menu snacks={snacks} title="Snack Menu" resource="snacks" />
            </Route>
            <Route exact path="/drinks">
              <Menu snacks={drinks} title="Drink Menu" resource="drinks" />
            </Route>
